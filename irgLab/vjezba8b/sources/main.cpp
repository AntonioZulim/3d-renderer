...
int main(int argc, char * argv[]) {
	...
	window = glfwCreateWindow(InputManager::width, InputManager::height, "Zadatak 8b", nullptr, nullptr);
	...
	glPolygonMode(GL_FRONT_AND_BACK, GL_TRIANGLES); // wireframe iscrtavanje
	...
	FPSManager FPSManagerObject(window, 60, 1.0, "Zadatak 8b");
